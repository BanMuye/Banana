...
namespace Banana {
    ...
    void SceneSerializer::Serialize(const std::string &filepath) {
        YAML::Emitter out;
        out << YAML::BeginMap;
        out << YAML::Key << "Scene" << YAML::Value << "Untiled";
        out << YAML::Key << "Entities" << YAML::Value << YAML::BeginSeq;
        m_Scene->m_Registry.view<TagComponent>().each([&](const auto entityID, auto &component) {
    ...
    void SceneSerializer::SerializeRuntime(const std::string &filepath) {
        BANANA_CORE_ASSERT(false, "Not implemented");
    }
    ...
    bool SceneSerializer::Deserialize(const std::string &filepath) {
        ...
        BANANA_CORE_TRACE("Deserializing scene '{0}'", sceneName);
