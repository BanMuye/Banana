...
namespace Banana {
    ...
    void Renderer2D::Init() {
        ...
        s_Data.QuadShader = Shader::Create("QuadShader",
                                           R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\quad_vertex_shader.glsl)",
                                           R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\quad_fragment_shader.glsl)",
                                           R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\quad_geometry_shader.glsl)"
        );


        s_Data.CircleShader = Shader::Create("CircleShader",
                                             R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\circle_vertex_shader.glsl)",
                                             R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\circle_fragment_shader.glsl)",
                                             R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\circle_geometry_shader.glsl)"
        );


        s_Data.LineShader = Shader::Create("LineShader",
                                           R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\line_vertex_shader.glsl)",
                                           R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\line_fragment_shader.glsl)",
                                           R"(D:\Files\S_Documents\Projects\Banana\BananaShake\assets\shaders\line_geometry_shader.glsl)"
        );
