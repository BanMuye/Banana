//
// Created by cyzho on 2025/10/14.
//
...
namespace Banana {
    EditorCamera::EditorCamera(float fov, float aspectRatio, float nearClip, float farClip) : m_FOV(fov),
    ...
    void EditorCamera::OnEvent(Event &event) {
        ...
        dispatcher.Dispatch<MouseScrolledEvent>(BANANA_BIND_EVENT_FN(EditorCamera::OnMouseScroll));
    }
