...
namespace Banana {
    ...
    void EditorLayer::UI_Toolbar() {
        ...
        if (ImGui::ImageButton("Play Button", (ImTextureID) icon->GetRendererID(), ImVec2(size, size), ImVec2(0, 0),
                               ImVec2(1, 1))) {
        ...
        if (m_ShowPhysicsColliders) {
            // Box Colliders
            {
                ...
                for (auto entity: view) {
                    ...
                    glm::mat4 transform = glm::translate(glm::mat4(1.0f), translation) * glm::rotate(
                                              glm::mat4(1.0f), tc.Rotation.z, glm::vec3(0.0f, 0.0f, 1.0f)) * glm::scale(
                                              glm::mat4(1.0f), scale);
            ...
            // Circle Colliders
            {
                ...
                for (auto entity: view) {
                    ...
                    glm::mat4 transform = glm::translate(glm::mat4(1.0f), translation) * glm::scale(
                                              glm::mat4(1.0f), scale);
